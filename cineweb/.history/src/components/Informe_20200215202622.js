...
const uri = "http://localhost:3001/peliculas"
    ...
    render() {
        return (
            <div class="flex px-3 py-2">
                <div class="flext-1 text-gray-700 text-center w-full bg-gray-400 px-2 py-2 m-2">
                ...
                <div class="flex-1 text-gray-700 text-center bg-white py-2 ">
                            ...
                            <tbody >
                                {
                                    this.state.peliculas.map(pelicula => {
                                        ...
                                        <tr key={pelicula._id}>
                                            ...
                                            <td class="py-4 px-10 bg-grey-lightest font-bold uppercase text-sm "><img src={pelicula.file} alt=""/></td>
                                            <div class="flex" >
