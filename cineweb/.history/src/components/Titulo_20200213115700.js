                ...
                <div class="text-gray-700 px-5 py-5 ">
                    <div class="bg-green-300 shadow-md rounded px-10 pt-4 pb-10 mb-30 flex flex-col my-150">
                        ...
                        <div class="w-3/3 mx-auto -400" >
                            <label class="w-64 flex flex-col items-center px-8 py-1 bg-green text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue hover:text-white">
