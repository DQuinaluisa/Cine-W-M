                ...
                <table class="text-left w-full border-collapse">
                    ...
                    <tbody >
                    {
                        peliculas.map(pelicula => {
                            return (
                                <tr >
                                    <td class="py-4 px-10 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light">{pelicula.titulo}</td>
                                    ...
                                    <td class="py-4 px-10 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light">{pelicula.categoria}>{pelicula.precio}</td>
                                    <td class="py-4 px-10 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light">{pelicula.categoria}>{pelicula.resumen}</td>
                                </tr>
                            )
                        }
