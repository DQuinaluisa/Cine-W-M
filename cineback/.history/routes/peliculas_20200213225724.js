...
router.post('/', upload.single('foto'), (req, res) =>{
    ...
    pelicula.precio = req.body.precio;
    pelicula.filename = req.file.filename;
    pelicula.path = '/img/uploads/' + req.file.filename;
    pelicula.originalname = req.file.originalname;
    pelicula.mimetype = req.file.mimetype;
    pelicula.size = req.file.size;
